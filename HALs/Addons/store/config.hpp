...
class cfgHALsStore 
{
	...
	class categories 
	{
		...
		class launchersCup 
		{
			...
			ITEM(CUP_launch_RPG26, 250, (round random 40 + 20));

			ITEM(CUP_launch_M72A6, 350, (round random 20 + 20));

			ITEM(CUP_launch_RPG7V, 650, (round random 20 + 20));

			ITEM(CUP_launch_MAAWS, 1250, (round random 10 + 20));

			ITEM(CUP_launch_Mk153Mod0, 1650, (round random 10 + 10));
			ITEM(CUP_launch_Mk153Mod0_blk, 1650, (round random 10 + 10));
		...
		class miscCup 
		{
			...
			ITEM(MineDetector, 100, (round random 25 + 25));
			ITEM(ChemicalDetector_01_watch_F, 75, (round random 25 + 25));

			ITEM(G_RegulatorMask_F, 200, (round random 25 + 25));
