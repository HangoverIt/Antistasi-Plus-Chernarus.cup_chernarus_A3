...
switch(_constructionType) do {
    ...
    case("SANDBAG_BUNKER"): {
        construction_buildingsAvailable = ["Land_BagBunker_01_small_green_F", "Land_HBarrier_01_tower_green_F", "Land_BagBunker_01_large_green_F"];
    ...
    case("BARRIERS"): {
        construction_buildingsAvailable = ["Land_HBarrier_01_line_5_green_F", "Land_HBarrier_01_line_3_green_F", "Land_BagFence_01_long_green_F", "Land_BagFence_01_short_green_F", "Land_BagFence_01_corner_green_F", "Land_BagFence_01_round_green_F"];
        construction_cost = 25;
        construction_buildTime = 20;
    };
    case("MISC"): {
        construction_buildingsAvailable = ["CamoNet_BLUFOR_F", "CamoNet_BLUFOR_open_F", "CamoNet_BLUFOR_big_F", "Land_CanvasCover_02_F", "Land_CanvasCover_01_F", "Land_PortableLight_single_F", "Land_PortableLight_double_F", "Land_LampShabby_F"];
