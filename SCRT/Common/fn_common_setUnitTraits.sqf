...
else
{
    switch (_type) do
    {
    	...
    	case "I_G_Soldier_SL_F": {player setUnitTrait ["camouflageCoef",0.6]; player setUnitTrait ["audibleCoef",0.6]; player setUnitTrait ["loadCoef",1]; player setUnitTrait ["medic", true]; player setSpeaker "Male03ENG"; _text = "Squad Leader role.<br/><br/>Squad Leaders are more lightweight units with increased camouflage capabilities. You also have combat medic skills."};
