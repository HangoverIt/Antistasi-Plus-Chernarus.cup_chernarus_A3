...
A3A_logistics_attachmentOffset = [
	...
	["CargoNet_01_barrels_F" call A3A_fnc_classNameToModel,                     [0,0,0.65],                 [1,0,0],                    2], //barrels from aidrop mission    
	["B_CargoNet_01_ammo_F" call A3A_fnc_classNameToModel,                      [0,0,0.65],                 [1,0,0],                    2], //weapons drop from NATO (if implemented)    
	...
	["Box_EAF_Equip_F" call A3A_fnc_classNameToModel,                 [0,0,0.44],                 [1,0,0],                    1],                         //Equipment box
	["Box_NATO_Wps_F" call A3A_fnc_classNameToModel,                            [0,0,0.22],                 [0,0,0],                    1],
    ["Box_EAF_Wps_F" call A3A_fnc_classNameToModel,                            [0,0,0.22],                 [0,0,0],                    1],
