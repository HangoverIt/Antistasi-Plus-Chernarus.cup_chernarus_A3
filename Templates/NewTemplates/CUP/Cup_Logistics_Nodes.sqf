...
A3A_logistics_vehicleHardpoints append [
	...
	["CUP_C_Fishing_Boat_Chernarus" call A3A_fnc_classNameToModel,[
       [1,         [-0.2,-3,-3.58],    []  ],
       [1,         [-0.2,-3.8,-3.58],    [3]  ],
       [1,         [-0.2,-4.6,-3.58],    [6]  ],
       [1,         [-0.2,-5.4,-3.58],    [4,5]  ]
...
A3A_logistics_attachmentOffset append [
    ...
    ["CUP_B_TOW_TriPod_USMC" call A3A_fnc_classNameToModel,                     [0.0, -0.7, 1.12],          [0, -1, 0],                   4,      250],               //TOW launcher
    ["CUP_B_TOW2_TriPod_USMC" call A3A_fnc_classNameToModel,                    [0.0, -0.7, 1.12],          [0, -1, 0],                  4,      250],               //TOW launcher
    ...
    ["CUP_O_KORD_high_RU" call A3A_fnc_classNameToModel,                        [0, -0.5, 1],             [0, 1, 0],                  4,      100],               //M2HB machinegun
    ["CUP_B_M2StaticMG_MiniTripod_USMC" call A3A_fnc_classNameToModel,          [-0.3, -0.1, 0.95],          [0, -1, 0],                  2,      100],            //M2HB sitting machinegun
    ...
    ["CUP_B_MK19_TriPod_USMC" call A3A_fnc_classNameToModel,                    [0, 0.25, 1.05],            [0, -1, 0],                 2,      100],        
    ...
    ["CUP_I_SPG9_NAPA" call A3A_fnc_classNameToModel,                          [-0.3, -1.3, 0.1],            [0, -1, 0],                 4,      100],     
    ["CUP_O_Kornet_RU" call A3A_fnc_classNameToModel,                           [0, -0.7, 0.77],            [0, 0, 0],                 4,      100],       
    ["CUP_I_DSHKM_NAPA" call A3A_fnc_classNameToModel,                           [0.3, -0.8, 1.65],          [0, 1, 0],                  4,      100],             //DShKM
    ["CUP_O_Igla_AA_pod_RU" call A3A_fnc_classNameToModel,                     [-0.26,-0.4,1.6],                  [0, -1, 0],                4,      250],
    ["CUP_I_2b14_82mm_NAPA" call A3A_fnc_classNameToModel,                       [0, -0.15, 0.8],            [0, -1, 0],                  2,      2000],              //Podnos Mortar
    ["CUP_B_M252_USMC" call A3A_fnc_classNameToModel,                           [0, -0.15, 0.75],            [0, -1, 0],                  2,      2000],              //Podnos Mortar
    ["CUP_B_L111A1_BAF_MPT" call A3A_fnc_classNameToModel,                     [0.35, -0.5, 1.1],          [0, 1, 0],                  4,      100],               //M2HB machinegun
    ["CUP_B_L134A1_TriPod_BAF_MPT" call A3A_fnc_classNameToModel,                    [0, 0.3, 1.05],            [0, -1, 0],                 2,      100],        
//Crates
    ["CUP_BOX_US_ARMY_Ammo_F" call A3A_fnc_classNameToModel,                      [0,0,0.35],                 [0,0,0],                    1],
    ["CUP_BOX_CDF_AmmoOrd_F" call A3A_fnc_classNameToModel,                      [0,0,0.82],                 [0,0,0],                    1],                     //loot crate
//Other
...
private _commonBlacklist = [ "C_Boat_Civil_01_F" call A3A_fnc_classNameToModel, "B_Boat_Transport_01_F" call A3A_fnc_classNameToModel, "C_Boat_Transport_02_F" call A3A_fnc_classNameToModel, "CUP_C_Fishing_Boat_Chernarus" call A3A_fnc_classNameToModel, "CUP_I_Datsun_4seat" call A3A_fnc_classNameToModel];
...
A3A_logistics_weapons append [
    ["CUP_B_DSHkM_MiniTriPod_CDF" call A3A_fnc_classNameToModel,["CUP_C_Fishing_Boat_Chernarus" call A3A_fnc_classNameToModel]],
    ["CUP_O_KORD_RU" call A3A_fnc_classNameToModel,_commonBlacklist],
    ["CUP_O_KORD_high_RU" call A3A_fnc_classNameToModel,[]],
    ["CUP_B_SearchLight_static_USMC" call A3A_fnc_classNameToModel,[]],
    ["CUP_B_TOW_TriPod_USMC" call A3A_fnc_classNameToModel,["CUP_C_Fishing_Boat_Chernarus" call A3A_fnc_classNameToModel]],
    ["CUP_B_TOW2_TriPod_USMC" call A3A_fnc_classNameToModel,["CUP_C_Fishing_Boat_Chernarus" call A3A_fnc_classNameToModel]],
    ["CUP_B_M2StaticMG_USMC" call A3A_fnc_classNameToModel,_commonBlacklist],
    ["CUP_B_M2StaticMG_MiniTripod_USMC" call A3A_fnc_classNameToModel,["CUP_C_Fishing_Boat_Chernarus" call A3A_fnc_classNameToModel]],
    ["CUP_B_MK19_TriPod_USMC" call A3A_fnc_classNameToModel,["CUP_C_Fishing_Boat_Chernarus" call A3A_fnc_classNameToModel]],
    ["CUP_I_DSHKM_NAPA" call A3A_fnc_classNameToModel,[]],
    ["CUP_O_Metis_RU" call A3A_fnc_classNameToModel,[]],
    ["CUP_O_Kornet_RU" call A3A_fnc_classNameToModel,[]],
    ["CUP_I_SPG9_NAPA" call A3A_fnc_classNameToModel, _commonBlacklist],
    ["CUP_B_AGS_CDF" call A3A_fnc_classNameToModel,[]],
    ["CUP_I_2b14_82mm_NAPA" call A3A_fnc_classNameToModel, _commonBlacklist],
    ["CUP_B_M252_USMC" call A3A_fnc_classNameToModel, _commonBlacklist],
    ["CUP_B_Igla_AA_pod_CDF" call A3A_fnc_classNameToModel, []],
	["CUP_B_L111A1_BAF_MPT" call A3A_fnc_classNameToModel,[]],
    ["CUP_B_L134A1_TriPod_BAF_MPT" call A3A_fnc_classNameToModel,_commonBlacklist]
];
