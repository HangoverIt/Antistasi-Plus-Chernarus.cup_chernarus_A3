...
if (A3A_hasCup) then {
	{
		...
		"CUP_H_CZ_Hat01", "CUP_H_CZ_Hat02", "CUP_H_CZ_Hat04", "CUP_H_CZ_Hat03", "CUP_H_CZ_Cap_rgr", "CUP_H_CZ_Cap_flag", "CUP_H_CZ_Cap_khk", "CUP_H_ChDKZ_Beret", "CUP_H_ChDKZ_Beanie", "CUP_H_ChDKZ_Cap", "CUP_H_RACS_Beret_Blue","H_Hat_Tinfoil_F","H_MilCap_gen_F","H_Beret_gen_F","H_Cap_police","H_Cap_blk_ION","H_Cap_grn_BI","H_Beret_EAF_01_F","H_Cap_blk_CMMG","H_Cap_usblack"
	];
};
