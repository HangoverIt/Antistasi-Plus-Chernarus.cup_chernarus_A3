...
Description:
	Checks if grenade or explosive created near Petrovsky. Punishes accordingly.
...
private _distancePetrovsky = _unit distance petrovsky;
if !(_distancePetrovsky <= 75) exitWith {false};
