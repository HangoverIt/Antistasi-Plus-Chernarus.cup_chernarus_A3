...
if !(isNull attachedTo petrovsky) then
{
    if(count _result == 1) then
    {
        ["Move HQ", "Put Petrovsky down before you move the HQ!"] call A3A_fnc_customHint;
    };
    _result pushBack "Petrovsky currently picked up";
};
