...
if (count hcArray == 0) exitWith {[petrovsky,"hint","No Headless Client Detected","AI Load Information"] remoteExec ["A3A_fnc_commsMP",remoteExecutedOwner]};
_textX = "";
...
[petrovsky, "hint", _textX, "AI Load Information"] remoteExec ["A3A_fnc_commsMP",remoteExecutedOwner];
