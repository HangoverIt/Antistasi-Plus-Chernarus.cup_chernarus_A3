...
//of course all the editor placed objects (petrovsky, flag, respawn marker etc..) have to be ported to the new island
...
switch (toLower worldName) do {
	...
	case "altis": {
		...
		["AgiosKonstantinos",39],["Abdera",89],["Panagia",91],["Nifi",24],["Rodopoli",212],["Kalithea",36],["Selakano",120],["Frini",69],["AgiosPetrovsky",11],["Feres",92],
...
if (isMultiplayer) then {
	[petrovsky, "hint","Zones Init Completed"] remoteExec ["A3A_fnc_commsMP", -2]
};
