...
//Intro.
DECLARE_SERVER_VAR(introDone, false);
publicVariable "introDone";
//JB_Missions.
DECLARE_SERVER_VAR(EEMissionStarted, false);
DECLARE_SERVER_VAR(EEMissionFailed, false);
DECLARE_SERVER_VAR(EEMissionCompleted, false);
DECLARE_SERVER_VAR(NATOSeaMissionStarted, false);
DECLARE_SERVER_VAR(NATOSeaMissionCompleted, false);
DECLARE_SERVER_VAR(T34MissionStarted, false);
DECLARE_SERVER_VAR(T34MissionCompleted, false);
DECLARE_SERVER_VAR(radar1Destroyed, false);
DECLARE_SERVER_VAR(radar2Destroyed, false);
DECLARE_SERVER_VAR(equipUnit, true);
//Trader position.
...
prestigeOPFOR = [100, 100] select cadetMode;												//Initial % support for NATO on each city
...
//JB polStn attack reset
polStn_1 setVariable ["attacked", false, true];
polStn_2 setVariable ["attacked", false, true];
polStn_3 setVariable ["attacked", false, true];
polStn_4 setVariable ["attacked", false, true];
polStn_5 setVariable ["attacked", false, true];
polStn_6 setVariable ["attacked", false, true];
polStn_7 setVariable ["attacked", false, true];
polStn_8 setVariable ["attacked", false, true];
polStn_9 setVariable ["attacked", false, true];
polStn_10 setVariable ["attacked", false, true];
polStn_11 setVariable ["attacked", false, true];
...
_civVehicles append [civBike, civCar, civTruck, civSupplyVehicle];			// Civ car/truck from rebel template, in case they're different
...
server setVariable [vehSDKTruck,600,true];
server setVariable [vehSDKLightArmed, 800, true];
server setVariable [vehSDKHeavyArmed, 1200, true];
server setVariable [vehSDKAT, 1500, true];
server setVariable [vehSDKAA, 2500, true];
server setVariable [vehSDKFuel, 750, true];
server setVariable [vehSDKPlane, 8000, true];

server setVariable [staticATteamPlayer, 1200, true];
server setVariable [staticAAteamPlayer, 1750, true];
server setVariable [SDKMortar, 1600, true];
