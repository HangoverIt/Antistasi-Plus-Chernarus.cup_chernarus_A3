...
[
    [teamPlayer,civilian],
    _taskId,
    [format ["An arms dealer has arrived on %2. Such reprobates alway show up where war is raging. As much as we might dislike dealing with such individuals, he is likely to be able to supply us with weapons and gear, for a price. %3. He trades his goods from a hideout in the forest outside of major cities. Go and establish contact with him.",nameOccupants,_worldName,name traderX, nameOccupants],
