...
//Tasks
////////////
private _text = format ["The police commander in %1 is terrorizing the population there. Kill him and people will breathe freely. Do this before %2.", _destinationName,_displayTime];
...
private _powCount = count _powPositions;
...
removeHeadgear _collaborant;
_collaborant addHeadgear "CUP_H_SLA_Beret";
