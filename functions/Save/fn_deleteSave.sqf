...
// Delete all server data for specified campaign
{
	...
	"areInvadersDefeated", "rebelLoadouts", "randomizeRebelLoadoutUniforms", "EEMissionStarted", "EEMissionFailed", "EEMissionCompleted", 
	"NATOSeaMissionStarted", "NATOSeaMissionCompleted", "T34MissionStarted", "T34MissionCompleted", "introDone", "radar1Destroyed", "radar2Destroyed"
];
