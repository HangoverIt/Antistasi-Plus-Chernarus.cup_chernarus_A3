...
// Save BoxX Inventory
boxXWeapons = weaponCargo boxX;
boxXMagazines = magazineCargo boxX;
boxXItems = itemCargo boxX;
boxXBackpacks = backpackCargo boxX;
...
["boxXWeapons", boxXWeapons] call A3A_fnc_setStatVariable;
["boxXMagazines", boxXMagazines] call A3A_fnc_setStatVariable;
["boxXItems", boxXItems] call A3A_fnc_setStatVariable;
["boxXBackpacks", boxXBackpacks] call A3A_fnc_setStatVariable;

//Intro
introDone = true;
publicVariable "introDone";
["introDone", introDone] call A3A_fnc_setStatVariable;

//JB Stuff
["EEMissionStarted", EEMissionStarted] call A3A_fnc_setStatVariable;
["EEMissionFailed", EEMissionFailed] call A3A_fnc_setStatVariable;
["EEMissionCompleted", EEMissionCompleted] call A3A_fnc_setStatVariable;
["NATOSeaMissionStarted", NATOSeaMissionStarted] call A3A_fnc_setStatVariable;
["NATOSeaMissionCompleted", NATOSeaMissionCompleted] call A3A_fnc_setStatVariable;
["T34MissionStarted", T34MissionStarted] call A3A_fnc_setStatVariable;
["T34MissionCompleted", T34MissionCompleted] call A3A_fnc_setStatVariable;
["radar1Destroyed", radar1Destroyed] call A3A_fnc_setStatVariable;
["radar2Destroyed", radar2Destroyed] call A3A_fnc_setStatVariable;
